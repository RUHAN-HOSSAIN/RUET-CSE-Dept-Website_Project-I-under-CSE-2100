...
const HeadCard = () => (
  <div className="flex-2 bg-white p-5 rounded-2xl border border-orange-100">
...
const AboutAndHead = () => {
  return (
    <>
      <div className="w-screen px-8 py-10 sm:p-15 md:p-20 xl:py-30 font-poppins bg-light-blue/5">

        <h1 className='z-5 flex items-center justify-center text-center text-blue font-bold font-inter text-xl sm:text-2xl md:text-3xl xl:text-4xl 2xl:text-5xl pb-5 sm:pb-7 md:pb-8 lg:pb-10 xl:pb-12'>
          About Computer Science & Engineering at RUET
        </h1>
        <p className='text-center mb-10 md:mb-15 xl:mb-20 text-sm md:text-base max-sm:line-clamp-5 max-md:line-clamp-6'>
