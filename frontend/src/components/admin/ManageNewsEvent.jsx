    ...
    <div className="relative bg-slate-100 min-h-full w-full font-poppins">
      ...
      <div className="px-20 py-10">
        ...
        <div className="flex items-center gap-2 mb-2 text-gray-400">
          ...
          &gt;
          <span className="text-blue font-medium">News & Events Management</span>
        </div>

        {/* Header */}
        <div className="flex items-center justify-between my-10 bg-white px-5 py-8 shadow-sm rounded-xl">
          <div>
            <h1 className="text-3xl font-bold text-dark-blue-2 leading-tight mb-1">News & Events</h1>
            <p className="text-gray-400 text-sm">Add, Update or Delete News & Events</p>
          </div>
        ...
        <div className="flex flex-wrap gap-3 mb-6">
          {NEWS_EVENT_FILTER_TYPES.map(f => (
            <button 
              ...
              className={`flex items-center gap-4 px-5 py-3 rounded-xl border text-sm font-medium transition-all cursor-pointer capitalize
