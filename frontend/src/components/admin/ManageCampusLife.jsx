    ...
    <div className="relative bg-slate-100 min-h-full w-full font-poppins">
      ...
      <div className="px-6 sm:px-10 md:px-15 lg:px-20 py-10">
        <div className="flex items-center gap-2 mb-2 text-gray-400">
          ...
          &gt;
          <span className="text-blue font-medium text-sm sm:text-base">Campus Life Management</span>
        </div>

        <div className="flex items-center justify-between my-10 bg-white px-5 py-8 shadow-sm rounded-xl">
          <div>
            <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-dark-blue-2 leading-tight mb-1">Campus Life</h1>
            <p className="text-gray-400 text-xs sm:text-sm">Add, Update or Delete Campus Life</p>
          </div>
              ...
              <div key={item._id} className="flex items-center gap-5 px-6 py-4 hover:bg-slate-50 transition-colors">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    <span className="text-[13px] text-gray-700">{item.category}</span>
