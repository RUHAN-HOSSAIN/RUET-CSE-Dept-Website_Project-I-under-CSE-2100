...
const NotFound = () => {
  return (
    <div className='relative overflow-hidden w-screen h-[90vh] flex items-center justify-center gap-20 bg-radial from-dark-blue-0 to-dark-blue-2'>
      ...
      {/* <div
        ...
        style={{
          backgroundImage: `
       radial-gradient(circle at center, #BBDCFF, transparent)
     `,
        }}
      /> */}
      ...
      <div className='relative flex flex-col items-center justify-center text-center
        ...
        <div className='absolute top-4 right-6 w-4 h-4 rounded-full bg-blue-300'></div>
        <div className='absolute top-8 right-13 w-2 h-2 rounded-full bg-pink-300'></div>
