    ...
    <div className="backdrop-blur-2xl fixed top-0 left-0 w-full h-full z-10 flex items-center justify-center">
      ...
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-120 max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold text-dark-blue-2 font-spaceG">Add New Notice</h2>
          <button
        ...
        <div className="mb-5">
          ...
          >
            {file ? (
              ...
              <div>
                <svg className="mx-auto mb-2 text-gray-300" xmlns="http://www.w3.org/2000/svg" height="36px" viewBox="0 -960 960 960" width="36px" fill="#9ca3af">
                  <path d="M440-200h80v-167l64 64 56-57-160-160-160 160 57 56 63-63v167ZM240-80q-33 0-56.5-23.5T160-160v-640q0-33 23.5-56.5T240-880h320l240 240v480q0 33-23.5 56.5T720-80H240Zm280-520v-200H240v640h480v-440H520ZM240-800v200-200 640-640Z" />
                </svg>
                <p className="text-sm text-gray-500">
                  Drag & drop PDF here or <span className="text-blue-500 font-medium">browse</span>
                </p>
