...
const NewsEvents = () => {
  ...
  return (
    <>
      ...
      />
      <PageHeroBanner title="News & Events" navLinks={SUB_NAV} activeTo="/news-events" />
        ...
        <div className="flex flex-col">
          ...
          <div className="flex gap-0">
            <div
              ...
              style={{
                padding: (!loading && items.length === 0) ? undefined : 'clamp(1.25rem, 3vw, 3rem) clamp(1rem, 3vw, 3rem)',
              }}
            >
              {loading ? (
                ...
                >
                  {items.map((item) => (
                    <div key={item._id} onClick={() => navigate(`/news-events/${item._id}`)} className="cursor-pointer">
                      <ContentCard
                        imgURL={item.imgURL}
                        title={item.title}
                        date={item.createdAt}
